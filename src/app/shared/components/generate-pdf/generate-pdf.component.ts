...
export class GeneratePdfComponent {
  generatePdf() {
    ...
    const imgVioleta = 'assets/img/flower/violeta.webp'
    ...
    const imgQuirquincho = 'assets/img/species/quirquincho.webp'
    const pilcomayo = "El Río Pilcomayo es un importante río transfronterizo que fluye desde los Andes en Bolivia, atraviesa Paraguay y Argentina, y desemboca en el río Paraguay, con un recorrido de aproximadamente 1,100 kilómetros. Es crucial para las comunidades indígenas y rurales que dependen de él para agua, pesca y agricultura. La cuenca del Pilcomayo alberga una biodiversidad única, incluyendo especies como el dorado y el yacaré. Sin embargo, enfrenta desafíos significativos, como la contaminación minera, sedimentación y variabilidad en su caudal, que impactan tanto el medio ambiente como a las comunidades humanas."
    const imgPilcomayo = 'assets/img/river/pilcomayo.webp'
